<div>
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="<?php echo e(route('predios.create')); ?>" wire:navigate
    ...
    <div class="bg-white border border-[#EDEAE2] rounded-xl overflow-hidden">
        <table class="w-full text-left">
            ...
            <tbody class="divide-y divide-[#F2EFE8]">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $predios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $predio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-[#FAFAF8] transition">
                        <td class="px-5 py-3.5 text-[13.5px] font-medium text-[#1C1B19]"><?php echo e($predio->codigo_catastral); ?></td>
                        <td class="px-5 py-3.5 text-[13.5px] text-[#3D3B36]"><?php echo e($predio->contribuyente?->nombre_completo); ?></td>
                        <td class="px-5 py-3.5 text-[13.5px] text-[#6B6862]"><?php echo e($predio->direccion); ?></td>
                        <td class="px-5 py-3.5">
                            <span class="text-[11.5px] px-2 py-1 rounded-md bg-[#F2EFE8] text-[#3D3B36] font-medium"><?php echo e(str($predio->uso)->replace('_', ' ')->ucfirst()); ?></span>
                        </td>
                        <td class="px-5 py-3.5 text-[13.5px] text-[#1C1B19]">
                            <?php echo e($predio->declaracionVigente ? 'S/ '.number_format($predio->declaracionVigente->valor_autovaluo, 2) : '—'); ?>

                        </td>
                        <td class="px-5 py-3.5 text-right">
                            <a href="<?php echo e(route('predios.show', $predio)); ?>" wire:navigate class="text-[13px] text-[#7A1F2B] hover:underline">Ver</a>
                        </td>
                    </tr>
    ...
    <div class="mt-4">
        <?php echo e($predios->links()); ?>

    </div>
</div>
<?php /**PATH C:\laragon\www\municipalidad-sistema V2\resources\views/livewire/predios/predio-index.blade.php ENDPATH**/ ?>