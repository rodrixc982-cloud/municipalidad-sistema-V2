...
<head>
    ...
    <title><?php echo e($title ?? 'Dashboard'); ?> · Sistema Municipal</title>
...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="w-64 flex-shrink-0 bg-[#18181B] flex flex-col">
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-5">
            ...
            <div>
                ...
                <a href="<?php echo e(route('dashboard')); ?>" wire:navigate
                   class="flex items-center gap-2.5 px-3 py-2 rounded-xl text-[13px] font-medium transition-all <?php echo e(request()->routeIs('dashboard') ? 'bg-[#7A1F2B] text-white shadow-lg shadow-[#7A1F2B]/30' : 'text-white/55 hover:bg-white/[0.06] hover:text-white'); ?>">
            ...
            <div>
                ...
                ?>
                <a href="<?php echo e(route('expedientes.index')); ?>" wire:navigate
                   class="flex items-center gap-2.5 px-3 py-2 rounded-xl text-[13px] font-medium transition-all <?php echo e(request()->routeIs('expedientes.*','carta-poder.*') ? 'bg-white/[0.1] text-white' : 'text-white/55 hover:bg-white/[0.06] hover:text-white'); ?>">
                ...
                <a href="<?php echo e(route('documentos.editor')); ?>" wire:navigate
                   class="flex items-center gap-2.5 px-3 py-2 rounded-xl text-[13px] font-medium transition-all <?php echo e(request()->routeIs('documentos.*') ? 'bg-white/[0.1] text-white' : 'text-white/55 hover:bg-white/[0.06] hover:text-white'); ?>">
            ...
            <div>
                ...
                <a href="<?php echo e(route('predios.index')); ?>" wire:navigate
                   class="flex items-center gap-2.5 px-3 py-2 rounded-xl text-[13px] font-medium transition-all <?php echo e(request()->routeIs('predios.*') ? 'bg-white/[0.1] text-white' : 'text-white/55 hover:bg-white/[0.06] hover:text-white'); ?>">
                ...
                <a href="<?php echo e(route('licencias.index')); ?>" wire:navigate
                   class="flex items-center gap-2.5 px-3 py-2 rounded-xl text-[13px] font-medium transition-all <?php echo e(request()->routeIs('licencias.*') ? 'bg-white/[0.1] text-white' : 'text-white/55 hover:bg-white/[0.06] hover:text-white'); ?>">
                ...
                <a href="<?php echo e(route('caja.index')); ?>" wire:navigate
                   class="flex items-center gap-2.5 px-3 py-2 rounded-xl text-[13px] font-medium transition-all <?php echo e(request()->routeIs('caja.*') || request()->routeIs('pagos.index') ? 'bg-white/[0.1] text-white' : 'text-white/55 hover:bg-white/[0.06] hover:text-white'); ?>">
            ...
            <div>
                ...
                <a href="<?php echo e(route('empleados.index')); ?>" wire:navigate
                   class="flex items-center gap-2.5 px-3 py-2 rounded-xl text-[13px] font-medium transition-all <?php echo e(request()->routeIs('empleados.*') ? 'bg-white/[0.1] text-white' : 'text-white/55 hover:bg-white/[0.06] hover:text-white'); ?>">
                ...
                <a href="<?php echo e(route('admin.usuarios')); ?>" wire:navigate
                   class="flex items-center gap-2.5 px-3 py-2 rounded-xl text-[13px] font-medium transition-all <?php echo e(request()->routeIs('admin.*') ? 'bg-white/[0.1] text-white' : 'text-white/55 hover:bg-white/[0.06] hover:text-white'); ?>">
        ...
        <div class="border-t border-white/[0.06] p-3">
            <a href="<?php echo e(route('admin.perfil')); ?>" wire:navigate
               class="flex items-center gap-2.5 px-2.5 py-2 rounded-xl hover:bg-white/[0.06] transition group mb-1">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->foto_perfil): ?>
                    <img src="<?php echo e(Storage::url(auth()->user()->foto_perfil)); ?>"
                ...
                <div class="min-w-0 flex-1">
                    <p class="text-[12.5px] font-medium text-white truncate leading-none"><?php echo e(auth()->user()->name); ?></p>
                    <p class="text-[11px] text-white/35 truncate leading-none mt-0.5"><?php echo e(auth()->user()->area ?? 'Sin área'); ?></p>
                </div>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1431964617-0', $__key);
...
?>
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        <header class="h-14 flex-shrink-0 flex items-center justify-between px-8 bg-white border-b border-[#EDEAE2] shadow-sm">
            <div>
                <h1 class="text-[15px] font-semibold text-[#1C1B19]"><?php echo e($title ?? 'Dashboard'); ?></h1>
            </div>
            <div class="flex items-center gap-3">
                <span class="text-[12.5px] text-[#A8A498]"><?php echo e(now()->translatedFormat('d \d\e F, Y')); ?></span>
                <div class="w-px h-4 bg-[#EDEAE2]"></div>
                <a href="<?php echo e(route('admin.perfil')); ?>" wire:navigate class="flex items-center gap-2 group">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->foto_perfil): ?>
                        <img src="<?php echo e(Storage::url(auth()->user()->foto_perfil)); ?>"
...
<?php /**PATH C:\laragon\www\municipalidad-sistema V2\resources\views/components/layouts/app.blade.php ENDPATH**/ ?>