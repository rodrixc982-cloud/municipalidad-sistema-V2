<div>
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="<?php echo e(route('licencias.create')); ?>" wire:navigate
    ...
    <div class="bg-white border border-[#EDEAE2] rounded-xl overflow-hidden">
        <table class="w-full text-left">
            ...
            <tbody class="divide-y divide-[#F2EFE8]">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $licencias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-[#FAFAF8] transition">
                        <td class="px-5 py-3.5 text-[13.5px] font-medium text-[#1C1B19]"><?php echo e($lic->numero_licencia); ?></td>
                        <td class="px-5 py-3.5 text-[13.5px] text-[#3D3B36]"><?php echo e($lic->nombre_comercial); ?></td>
                        <td class="px-5 py-3.5 text-[13.5px] text-[#6B6862]"><?php echo e($lic->contribuyente?->nombre_completo); ?></td>
                        <td class="px-5 py-3.5 text-[13px] text-[#6B6862]"><?php echo e($lic->giro_negocio); ?></td>
                        <td class="px-5 py-3.5 text-[13px] text-[#6B6862]"><?php echo e($lic->fecha_vencimiento?->format('d/m/Y') ?? '—'); ?></td>
                        <td class="px-5 py-3.5">
                            <span class="text-[11.5px] px-2 py-1 rounded-md font-medium <?php echo e(match($lic->estado) { 'vigente' => 'bg-emerald-100 text-emerald-700', 'vencida' => 'bg-red-100 text-red-700', default => 'bg-slate-100 text-slate-700' }); ?>">
                                <?php echo e(str($lic->estado)->ucfirst()); ?>

                            </span>
                        </td>
                        <td class="px-5 py-3.5 text-right">
                            <a href="<?php echo e(route('licencias.pdf', $lic)); ?>" target="_blank" class="text-[13px] text-[#7A1F2B] hover:underline">PDF</a>
                        </td>
                    </tr>
    ...
    <div class="mt-4"><?php echo e($licencias->links()); ?></div>
</div>
<?php /**PATH C:\laragon\www\municipalidad-sistema V2\resources\views/livewire/licencias/licencia-index.blade.php ENDPATH**/ ?>