<div x-data x-init="initCharts()" class="space-y-6">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="bg-white border border-[#EDEAE2] rounded-2xl p-5 shadow-sm">
            ...
            <p class="text-[2rem] font-bold text-[#1C1B19] tracking-tight"><?php echo e(number_format($totalExpedientes)); ?></p>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($expedientesVencidos > 0): ?>
                <p class="text-[12px] text-red-500 mt-1 flex items-center gap-1">
                    ...
                    <?php echo e($expedientesVencidos); ?> vencidos
                </p>
            <?php else: ?>
        ...
        <div class="bg-white border border-[#EDEAE2] rounded-2xl p-5 shadow-sm">
            ...
            <p class="text-[2rem] font-bold text-[#1C1B19] tracking-tight"><?php echo e(number_format($expedientesPendientes)); ?></p>
        ...
        <div class="bg-white border border-[#EDEAE2] rounded-2xl p-5 shadow-sm">
            ...
            <p class="text-[2rem] font-bold text-[#1C1B19] tracking-tight">S/&nbsp;<?php echo e(number_format($recaudacionMes, 0)); ?></p>
            <p class="text-[12px] text-[#A8A498] mt-1">Total año: S/ <?php echo e(number_format($recaudacionAnio, 0)); ?></p>
        </div>
        ...
        <div class="bg-white border border-[#EDEAE2] rounded-2xl p-5 shadow-sm">
            ...
            <p class="text-[2rem] font-bold text-[#1C1B19] tracking-tight"><?php echo e(number_format($licenciasVigentes)); ?></p>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($licenciasVencidas > 0): ?>
                <p class="text-[12px] text-red-500 mt-1"><?php echo e($licenciasVencidas); ?> vencidas</p>
            <?php else: ?>
                <p class="text-[12px] text-[#A8A498] mt-1"><?php echo e($totalPredios); ?> predios · <?php echo e($totalEmpleados); ?> empleados</p>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 bg-white border border-[#EDEAE2] rounded-2xl shadow-sm">
            <div class="flex items-center justify-between px-6 py-4 border-b border-[#EDEAE2]">
                ...
                <a href="<?php echo e(route('expedientes.index')); ?>" wire:navigate class="text-[12.5px] text-[#7A1F2B] hover:underline">Ver todos →</a>
            </div>
            <div class="divide-y divide-[#F2EFE8]">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $actividadReciente; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-center gap-4 px-6 py-3.5">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-[13.5px] font-medium text-[#1C1B19] truncate"><?php echo e($exp->numero_expediente); ?></p>
                            <p class="text-[12px] text-[#A8A498] truncate"><?php echo e($exp->contribuyente?->nombre_completo); ?> · <?php echo e($exp->tipoTramite?->nombre); ?></p>
                        </div>
                        <span class="text-[11px] px-2 py-1 rounded-full font-medium whitespace-nowrap <?php echo e($exp->colorEstado()); ?>">
                            <?php echo e(str($exp->estado)->replace('_', ' ')->ucfirst()); ?>
        ...
        <div class="space-y-3">
            ...
            <a href="<?php echo e(route('expedientes.create')); ?>" wire:navigate class="flex items-center gap-3 p-4 bg-white border border-[#EDEAE2] rounded-2xl hover:border-[#7A1F2B]/30 hover:bg-[#FEF9F9] transition shadow-sm group">
            ...
            <a href="<?php echo e(route('caja.index')); ?>" wire:navigate class="flex items-center gap-3 p-4 bg-white border border-[#EDEAE2] rounded-2xl hover:border-emerald-300 hover:bg-emerald-50/40 transition shadow-sm">
            ...
            <a href="<?php echo e(route('predios.create')); ?>" wire:navigate class="flex items-center gap-3 p-4 bg-white border border-[#EDEAE2] rounded-2xl hover:border-blue-300 hover:bg-blue-50/40 transition shadow-sm">
            ...
            <a href="<?php echo e(route('carta-poder.form')); ?>" wire:navigate class="flex items-center gap-3 p-4 bg-white border border-[#EDEAE2] rounded-2xl hover:border-purple-300 hover:bg-purple-50/40 transition shadow-sm">
...
function initCharts() {
    ...
    const datosRecaudacion = <?php echo json_encode($recaudacionMensual, 15, 512) ?>;
    ...
    const estados = <?php echo json_encode($expedientesPorEstado, 15, 512) ?>;
    ...
    const datosExpedientes = <?php echo json_encode($expedientesMensuales, 15, 512) ?>;
    ...
    const tramites = <?php echo json_encode($tramitesTop, 15, 512) ?>;
...
<?php /**PATH C:\laragon\www\municipalidad-sistema V2\resources\views/livewire/dashboard/index.blade.php ENDPATH**/ ?>