                    ...
                    <tr class="hover:bg-[#FAFAF8] transition group">
                        <td class="px-5 py-4">
                            <div class="flex items-center gap-3">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($usuario->foto_perfil): ?>
                                    <img src="<?php echo e(Storage::url($usuario->foto_perfil)); ?>" alt="<?php echo e($usuario->name); ?>"
                                ...
                                <?php else: ?>
                                    <div class="w-9 h-9 rounded-full bg-[#7A1F2B] flex items-center justify-center text-white text-[12px] font-semibold ring-2 ring-[#EDEAE2]">
                                        <?php echo e($usuario->iniciales); ?>

                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <div>
                                    <p class="text-[13.5px] font-medium text-[#1C1B19]"><?php echo e($usuario->name); ?></p>
                                    <p class="text-[12px] text-[#A8A498]"><?php echo e($usuario->email); ?></p>
                                </div>
                            </div>
                        </td>
                        <td class="px-5 py-4 text-[13.5px] text-[#6B6862]"><?php echo e($usuario->area ?? '—'); ?></td>
                        <td class="px-5 py-4">
                            <span class="text-[11.5px] px-2.5 py-1 rounded-full font-medium bg-[#F2EFE8] text-[#7A1F2B]">
                                <?php echo e($usuario->roles->first()?->name ?? '—'); ?>

                            </span>
                        </td>
                        <td class="px-5 py-4">
                            <span class="inline-flex items-center gap-1.5 text-[12px] font-medium <?php echo e($usuario->activo ? 'text-emerald-700' : 'text-red-600'); ?>">
                                <span class="w-1.5 h-1.5 rounded-full <?php echo e($usuario->activo ? 'bg-emerald-500' : 'bg-red-500'); ?>"></span>
                        ...
                        <td class="px-5 py-4 text-right">
                            <div class="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition">
                                <button wire:click="abrirEditar(<?php echo e($usuario->id); ?>)"
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($usuario->id !== auth()->id()): ?>
                                    <button wire:click="confirmarEliminar(<?php echo e($usuario->id); ?>)"
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4" x-data>
            ...
            <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden">
                <div class="flex items-center justify-between px-6 py-4 border-b border-[#EDEAE2]">
                    <h3 class="text-[15px] font-semibold text-[#1C1B19]"><?php echo e($esEdicion ? 'Editar usuario' : 'Nuevo usuario'); ?></h3>
                    ...
                    <div class="flex items-center gap-4 pb-4 border-b border-[#F2EFE8]">
                        <div class="relative">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($foto): ?>
                                <img src="<?php echo e($foto->temporaryUrl()); ?>" class="w-16 h-16 rounded-full object-cover ring-2 ring-[#7A1F2B]/20"/>
                            <?php elseif($esEdicion && ($u = App\Models\User::find($usuarioId)) && $u->foto_perfil): ?>
                                <img src="<?php echo e(Storage::url($u->foto_perfil)); ?>" class="w-16 h-16 rounded-full object-cover ring-2 ring-[#7A1F2B]/20"/>
                            <?php else: ?>
                                <div class="w-16 h-16 rounded-full bg-[#F2EFE8] flex items-center justify-center text-[#7A1F2B] text-xl font-bold">
                                    <?php echo e($name ? strtoupper(substr($name, 0, 2)) : '?'); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        <label class="block text-[12.5px] font-medium text-[#3D3B36] mb-1.5">
                            Contraseña <?php echo e($esEdicion ? '(dejar vacío para no cambiar)' : ''); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <select wire:model="rol" class="w-full rounded-xl border border-[#E3E0D9] px-3.5 py-2.5 text-[13.5px] bg-white focus:outline-none focus:ring-2 focus:ring-[#7A1F2B]/20 focus:border-[#7A1F2B]">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($r->name); ?>"><?php echo e(str($r->name)->replace('_', ' ')->title()); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="flex justify-end gap-3 px-6 py-4 border-t border-[#EDEAE2] bg-[#FAFAF8]">
                    ...
                    <button wire:click="guardar" wire:loading.attr="disabled"
                        ...
                        <?php echo e($esEdicion ? 'Guardar cambios' : 'Crear usuario'); ?>
...
<?php /**PATH C:\laragon\www\municipalidad-sistema V2\resources\views/livewire/admin/usuario-index.blade.php ENDPATH**/ ?>